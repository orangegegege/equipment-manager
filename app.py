...
<style>
    ...
    /* 🔥🔥🔥 5. 手機版智慧排版 (Smart Mobile Layout) 🔥🔥🔥 */
    @media (max-width: 640px) {
        
        /* 策略 A: 針對「包含按鈕」的區塊 -> 強制左右並排 (App 操作感) */
        /* 使用 :has() 語法，只影響有按鈕的那一行，不會影響儀表板 */
        div[data-testid="stHorizontalBlock"]:has(button) {
            flex-wrap: nowrap !important;
            gap: 10px !important; /* 按鈕之間的間距 */
        }
        ...
        /* 策略 B: 其他區塊 (如儀表板 metrics) -> 維持直向堆疊 (閱讀感) */
        /* 這裡不需要寫 CSS，因為 Streamlit 預設就是直向，我們只要不干擾它就好 */
    }
</style>
...
# ==========================================
def login_page():
    # 這裡改成 [1, 10, 1] 讓中間空白更大，確保在電腦版也是左右對齊
    # 手機版因為有上面的 CSS 強制介入，會忽略比例，直接 50%-50% 並排
